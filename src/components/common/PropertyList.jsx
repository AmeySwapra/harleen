  ...
  return (
    <Box p={5} px={{ base: 4, md: 8, lg: 14 }}>
      ...
      <Text fontSize="2xl" fontWeight="bold" textAlign="center">
        Discover Best Residential & Commercial Properties in Pune.
      </Text>
      <Text fontSize="md" fontWeight="normal" textAlign="center" mb={5}>
        New upcoming Residential projects in Pune.
      </Text>
        ...
        <Flex justifyContent="space-between" alignItems="center" mb={5}>
          ...
          <Flex>
            <IconButton
              ...
              background={isGridView ? "#fdb92e" : "gray"}
              mr={2}
            />
            <IconButton
              icon={<FaList />}
          ...
          {currentProperties.map((property) => (
            ...
            >
              ...
              <Box p={5}>
                ...
                <Text fontWeight="bold" color="#fdb92e" mb={2}>
                  {property.price}
                </Text>
                <Text fontSize="sm" color="gray.500" mb={2}>
                  {property.beds} Beds | {property.baths} Baths | {property.area}
                </Text>
                <Button background={'#fdb92e'} color={'white'} as="a" href={property.link}>
                  View Details
                </Button>
              </Box>
            </Box>
          ...
          {currentProperties.map((property) => (
            ...
            >
              ...
              <Box p={5}>
                ...
                <Button color={'white'} background={'#fdb92e'} as="a" href={property.link}>
                  View Details
                </Button>
              </Box>
            </Box>
